...
public class FRC2024WeaponsController extends HuskyXbox{
  private static final int FRC2024_WEAPONS_CONTROLLER_PORT = 1;
  ...
  public FRC2024WeaponsController(){
      super(FRC2024_WEAPONS_CONTROLLER_PORT);
  }
